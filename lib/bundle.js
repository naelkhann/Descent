...
var Bullet = function () {
  function Bullet(stage, ship, pos_x, pos_y, id) {
  ...
  _createClass(Bullet, [{
    ...
    value: function checkCollisions(obj) {
      if (this.shape.x >= obj.x + obj._bounds.width || this.shape.x + this.shape._bounds.width <= obj.x || this.shape.y >= obj.y + obj._bounds.height || this.shape.y + this.shape._bounds.height <= obj.y) {
        console.log("hit");
        return false;
      }
      return true;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.stage = stage;
  var ship = new _ship2.default(stage);
  var enemies = {};
  for (var i = 0; i < 5; i++) {
  ...
  window.enemiesObjs = (0, _lodash.values)(enemies);
  ...
  ship.shape.on("mousedown", function (e) {
    bulletInterval = setInterval(function () {
      var bullet = new _bullet2.default(stage, ship, ship.shape.x + 20, ship.shape.y, Util.generateId());
