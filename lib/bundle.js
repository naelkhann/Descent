...
var Game = function () {
  function Game() {
    ...
    this.enemiesObjs = (0, _lodash.values)(this.enemies);
    window.enemiesObjs = this.enemiesObjs;

    this.ship = new _ship2.default(this.stage, this.enemies);
    ...
    this.ship.shape.on("mousedown", function (e) {
    ...
    this.ship.shape.on("pressup", function (e) {
